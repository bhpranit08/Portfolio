    ...
    return (
        <div className='max-w-2xl flex flex-col items-center justify-start gap-4'>
            ...
            <div className="flex items-center justify-center gap-4">
                <a href="https://github.com/darkwood23" target='_blank' className='group transition duration-300' onMouseEnter={() => setChangeColor(true)} onMouseLeave={() => setChangeColor(false)}>
